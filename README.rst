...
This library combines functionalities from xarray, rasterio/gdal and shapely/ogr for analysis and processing of geoscientific data
...
.. code-block:: console
  ...
  git clone https://github.com//xgeo.git
  cd xgeo
  pip install .
...
If you want to contribute to the development of xgeo,
